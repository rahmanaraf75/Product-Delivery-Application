...
import 'shoes_list_model.dart';
export 'shoes_list_model.dart';

class ShoesListWidget extends StatefulWidget {
  const ShoesListWidget({Key? key}) : super(key: key);

  @override
  _ShoesListWidgetState createState() => _ShoesListWidgetState();
}

class _ShoesListWidgetState extends State<ShoesListWidget> {
  late ShoesListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShoesListModel());
